...
function whc_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'footer-sidebar',
		'description'   => esc_html__( 'Add your footer stuff.', 'whc' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function whc_scripts() {
	...
	// Enqueue bootstrap css and js files 
	...
	// Enqueue sass style sheet 
	wp_enqueue_style('whc-style', get_template_directory_uri() . '/sass/style.scss', array(), '1.0.0', 'all');

	wp_enqueue_script( 'jquery' );

	wp_enqueue_script( 'whc-bootstrap_js', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '20170710', true );

	// End of bootstrap enqueue
